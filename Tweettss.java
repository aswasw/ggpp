...
public class Tweettss {

	
	
	
	//	Set this to your actual CONSUMER KEY and SECRET for your application as given to you by dev.twitter.com
	private static final String CONSUMER_KEY		="luCMgoolgODpFH9rxcvLbRqYt";
	private static final String CONSUMER_SECRET 	= "lW9fERVDfcgoq3aqVDYpbUNGkKUUFquwpQYrLvlaXzeekpvkgZ";
        String r ;
	...
	public static OAuth2Token getOAuth2Token()
	{
		...
		cb.setOAuthConsumerKey("iI4Yy9PZHzjcUIRAZDiBhlsIz").setOAuthConsumerSecret("qDfkTJhwUIzlTNBbBj1NqOo5Ws7hJqmk6ok2VHMoXtPaxVaiTq");
...
// Loop through all the tweets...
				{
					...
					System.out.printf("At %s, @%-20s said:  %s  ,Retweet count:%s, favorite count:%s , location :%s  language :%s\n",
                                 ...
                                 new FileOutputStream("tweetsoutput.txt", true), "UTF-8"))) {
                                 writer.write("At "+s.getCreatedAt().toString()+"@"+s.getUser().getScreenName()+"   said: "+ cleanText(s.getText())+
                                 ",Retweet count:" + s.getRetweetCount() +" ,favorite count:" + s.getFavoriteCount() +" ,location :" +s.getGeoLocation() + " ,language :"+ s.getLang());
...
//writer.write("At "+s.getCreatedAt().toString()+"@"+s.getUser().getScreenName()+"       said:\n"+ cleanText(s.getText()));
